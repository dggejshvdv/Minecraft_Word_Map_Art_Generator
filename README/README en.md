...
- 🎨 **16 Minecraft Concrete Colors**: White, Orange, Magenta, Light Blue, Yellow, Lime, Pink, Gray, Silver, Cyan, Purple, Blue, Brown, Green, Red, Black
- ✍️ **Custom Font Support**: Place font files in the `ttf/` directory
...
Place font files (.ttf format) in the `ttf/` directory. The tool automatically detects font files in this directory (up to 10).
...
1. **Select Font**: Choose a font from the dropdown menu (fonts in `ttf/` directory)
2. **Input Text**: Enter the text or symbols to generate (supports multiple characters)
3. **Select Color**: Click a color button to choose the text color
4. **Insert Symbols**: Click symbols from the symbol panel to insert directly
5. **Generate**: Click the "Generate Projection File" button
...
[1/4] Generating: '你'
  Success! Projection file: litematic/AaZhuNiWoMingMeiXiangChunTian-2_你_红色_1234.litematic
  Block count: 1234

[2/4] Generating: '好'
  Success! Projection file: litematic/AaZhuNiWoMingMeiXiangChunTian-2_好_红色_1567.litematic
  Block count: 1567

[3/4] Generating: '世'
  Success! Projection file: litematic/AaZhuNiWoMingMeiXiangChunTian-2_世_红色_1100.litematic
  Block count: 1100

[4/4] Generating: '界'
  Success! Projection file: litematic/AaZhuNiWoMingMeiXiangChunTian-2_界_红色_1345.litematic
  Block count: 1345
...
- Text input field
- Color selection panel (16 concrete colors)
...
Translation files directory containing:
...
`FontName_Character_Color_BlockCount.litematic`

Example: `AaZhuNiWoMingMeiXiangChunTian-2_你_红色_1234.litematic`
...
- Language can be switched anytime in the top-right corner (Chinese/English)
...
- Font files must be prepared by the user, ensure proper usage rights
